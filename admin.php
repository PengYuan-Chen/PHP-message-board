    ...
    <div class="main">
        ...
        while($rows=$result->fetch_assoc()){
            foreach($rows as $itm=>$val){
                ...
                elseif($itm=="boardsubject"){
                    ?>
                    <td><p class="sub"><?php echo "<hr>[".$rows["boardid"]."]".$rows[$itm]  ?></p></td>
                    <td class="btndo"><a href="./adminfix.php?id=<?php echo $rows["boardid"] ?>">[修改]</a><?php echo" "; ?><a href="./admindel.php?id=<?php echo $rows["boardid"]?>">[刪除]</a></p>
                    </tr>   
                    <?php
                }
        ...
        <table class="tab2">
            <tr>
                ...
                if($num_pages==1){
                ?>
                    <td colspan="2"><a href="./admin.php?page=<?php echo $num_pages+1 ?>">下一頁</a></td>
                    <td colspan="2"><a href="./admin.php?page=<?php echo $total_pages ?>">最末頁</a></td>
                <?php
                }elseif($num_pages==$total_pages){
                ?>
                    <td><a href="./admin.php?page=<?php echo 1 ?>">第一頁</a></td>
                    <td><a href="./admin.php?page=<?php echo $num_pages-1 ?>">上一頁</a></td>
                <?php
                }else{
                ?>
                    <td><a href="./admin.php?page=<?php echo $num_pages-1 ?>">上一頁</a></td>
                    <td><a href="./admin.php?page=<?php echo $num_pages+1 ?>">下一頁</a></td>
                <?php
                }
                ?>
            </tr>
        ...
        <a href="./index.php?logout=1"><img src="./images/logout.jpg"></a>
    </div>
</body>
</html>
